...
export const FaultCodes  = {
  ...
  0x05: 'Invalid length',
  0x06: 'Parameter wrong / out of range. One or more of the parameters were wrong, i.e. not within the boundaries specified for the function',
  0x07: 'Parameter not available. One or more of the parameters were within the boundaries specified for the function, but are not available at that time.',
  0x0a: 'Secondary Node',
  0x0b: 'Device Malfunction',
  0x0c: 'Segmentation Error',
  0x20: 'Function Specific',
  0x40: 'Busy',
  0x41: 'Not available -- Function is implemented in principle, but is not available at the moment',
